import bannerBackground from "../assets/banner_wallpapers.svg";
const Expertise = () => {
  return (
    <>
      <div className="mt-2">
        ...
        >
          <div className="flex text-white justify-center">
            ...
            <div className="w-2/3 text-center space-y-4">
              ...
              <p>
              Front-end and back-end development, algorithms, SQL, Python, and 
              Linux are key to building scalable, secure, and
              efficient solutions. Mastering these technologies
               empowers developers to create innovative systems 
